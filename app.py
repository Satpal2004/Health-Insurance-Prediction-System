...
# ── Page config ────────────────────────────────────────────────────────────────
st.set_page_config(
    page_title="Life Insurance · Premium Predictor",
    page_icon="🛡️",
    layout="centered",
)
...
def get_background_image_base64():
    img_path = Path(__file__).parent / "static files" / "background.png"
    if img_path.exists():
...
# ══════════════════════════════════════════════════════════════════════════════
bg_style = f"data:image/png;base64,{bg_base64}" if bg_base64 else "#f5f5f5"
...
<div class="hero-banner">
  ...
  <div class="hero-title">Life Insurance<br><span>Premium</span> Predictor</div>
...
<div class="disclaimer">
  © 2026 Life Insurance Premium Predictor· Build by Satpal Sharma
</div>
""", unsafe_allow_html=True)